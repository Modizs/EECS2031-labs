...
int main() {
 ...
 {		
    ...
    /* 3, shifting only, to push off unwanted bits*/  
          first shift left to the end, pushing off bits on left, then shift right to the end, pushing off bit on right.
          dangeous >>.  rgb_pack need to be unsigned!   */
